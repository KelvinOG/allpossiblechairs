...
;(function ($) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Page = function (contentNode, index, options) {
                ...
                if (
                    ...
                    contentNode.parent().append('<div class="b-counter">' + startingPageNumber + '/50' + '</div>');
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updateOptions = function (newOptions) {
                ...
                if (!options.height) {
                    ...
                    options.height = options.height.replace('%', '');
                } else if (typeof options.height == 'string' && options.height.indexOf("%") != -1) {
                    hPercent = true;
                ...
                if (options.menu && $(options.menu).length > 0) {
                    ...
                    if (options.pageSelector && menu.find('.b-selector-page').length == 0) {
                       ...
                       // pageSelector = $('<div class="b-selector b-selector-page"><span class="b-current">' + (options.currentIndex + 1) + ' — ' + (options.currentIndex + 2) + '</span></div>').appendTo(menu);
                        ...
                        pageSelector = $('<div class="b-selector b-selector-page"><span class="b-current">' + (options.currentIndex + 2) + '/52 </span></div>').appendTo(menu);
            ...
            updateMenu = function () {
                if (options.pageSelector) {
                    ...
                    if (options.direction == directions.rightToLeft) {
                        ...
                        currentPageNumbers =  (options.currentIndex + 2) + '/50'
                        ;
                        if (options.closed) {
                            if (options.currentIndex == 0) {
                                currentPageNumbers = '1' + ' / 52'
                            } else if (options.currentIndex == options.pageTotal - 2) {
                                currentPageNumbers = options.pageTotal - 2
                            } else {
                                currentPageNumbers = (options.currentIndex) /*+ '-' + (options.currentIndex + 1)*/ + ' / 52';
                            }
                            ...
                            if (options.covers) {
                                if (options.currentIndex == 0) {
                                    ...
                                    currentPageNumbers = (options.currentIndex - 1) + '-' + (options.currentIndex) + ' / 52';
                                }
                            }
                        }
                    }
    ...
    $.fn.booklet.defaults = {
        ...
        menu: '#pselecter-menu',                            // selector for element to use as the menu area, required for 'pageSelector'
